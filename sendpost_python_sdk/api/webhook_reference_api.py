...
class WebhookReferenceApi:
    ...
    def send_post_webhooks_post(
        ...
        :param webhook_object:
        :type webhook_object: WebhookObject
        ...
        _param = self._send_post_webhooks_post_serialize(
    ...
    @validate_call
    def send_post_webhooks_post_with_http_info(
        self,
        webhook_object:  = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_post_webhooks_post_without_preload_content(
        self,
        webhook_object:  = None,
        _request_timeout: Union[
            None,
    ...
    def _send_post_webhooks_post_serialize(
        self,
        webhook_object,
        _request_auth,
        _content_type,
        ...
        if webhook_object is not None:
            _body_params = webhook_object
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/SendPostWebhooks',
