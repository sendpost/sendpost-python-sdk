...
class SubAccount(BaseModel):
    ...
    created: Optional[StrictInt] = Field(default=None, description="UNIX epoch nano timestamp when the sub-account was created.")
    created_by: Optional[Dict[str, Any]] = Field(default=None, description="Member who created the sub-account")
    updated_by: Optional[Dict[str, Any]] = Field(default=None, description="Member who updated the sub-account")
    blocked: Optional[StrictBool] = Field(default=None, description="Indicates whether the sub-account is blocked")
    blocked_at: Optional[StrictInt] = Field(default=None, description="UNIX epoch nano timestamp when the sub-account was blocked (0 if not blocked)")
    block_reason: Optional[StrictStr] = Field(default=None, description="Reason for blocking the sub-account")
    hb_exempt: Optional[StrictBool] = Field(default=None, description="Indicates whether the sub-account is exempt from hard bounce tracking")
    generate_weekly_report: Optional[StrictBool] = Field(default=None, description="Indicates whether weekly reports are generated for this sub-account")
    handlers: Optional[List[StrictStr]] = Field(default=None, description="Handlers associated with the sub-account")
    __properties: ClassVar[List[str]] = ["id", "apiKey", "name", "labels", "smtpAuths", "type", "isPlus", "created", "created_by", "updated_by", "blocked", "blocked_at", "block_reason", "hb_exempt", "generate_weekly_report", "handlers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.smtp_auths:
            for _item_smtp_auths in self.smtp_auths:
                if _item_smtp_auths:
                    _items.append(_item_smtp_auths.to_dict())
            _dict['smtpAuths'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hb_exempt": obj.get("hb_exempt"),
            "generate_weekly_report": obj.get("generate_weekly_report"),
