...
class Domain(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "dkim", "returnPath", "track", "dmarc", "dkimConfig", "dkimVerified", "dmarcVerified", "returnPathVerified", "trackVerified", "verified", "domainRegisteredDate", "created", "gptVerified", "gpt", "dmarcFailureReason", "dkimFailureReason", "trackFailureReason", "returnPathFailureReason"]
