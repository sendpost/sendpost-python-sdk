...
class EmailStatsStats(BaseModel):
    """
    EmailStatsStats
    """ # noqa: E501
    ...
    delivered: Optional[StrictInt] = Field(default=None, description="Number of emails successfully delivered to SMTP without errors")
    dropped: Optional[StrictInt] = Field(default=None, description="Number of emails dropped without attempting to deliver due to invalid email or suppression list")
    smtp_dropped: Optional[StrictInt] = Field(default=None, description="Number of emails dropped by SMTP", alias="smtpDropped")
    hard_bounced: Optional[StrictInt] = Field(default=None, description="Number of emails that resulted in a hard bounce error", alias="hardBounced")
    soft_bounced: Optional[StrictInt] = Field(default=None, description="Number of emails that resulted in a temporary soft bounce error", alias="softBounced")
    ...
    unsubscribed: Optional[StrictInt] = Field(default=None, description="Number of email recipients who unsubscribed")
    spam: Optional[StrictInt] = Field(default=None, description="Number of emails marked as spam by recipients")
