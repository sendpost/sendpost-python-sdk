...
class AutoWarmupPlan(BaseModel):
    """
    AutoWarmupPlan
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique ID for the auto-warmup plan")
    name: Optional[StrictStr] = Field(default=None, description="Name of the auto-warmup plan")
    gmail_warmup_plan: Optional[StrictStr] = Field(default=None, description="Gmail warmup plan configuration in JSON format", alias="gmailWarmupPlan")
    yahoo_warmup_plan: Optional[StrictStr] = Field(default=None, description="Yahoo warmup plan configuration in JSON format", alias="yahooWarmupPlan")
    aol_warmup_plan: Optional[StrictStr] = Field(default=None, description="AOL warmup plan configuration in JSON format", alias="aolWarmupPlan")
    microsoft_warmup_plan: Optional[StrictStr] = Field(default=None, description="Microsoft warmup plan configuration in JSON format", alias="microsoftWarmupPlan")
    comcast_warmup_plan: Optional[StrictStr] = Field(default=None, description="Comcast warmup plan configuration in JSON format", alias="comcastWarmupPlan")
    yandex_warmup_plan: Optional[StrictStr] = Field(default=None, description="Yandex warmup plan configuration in JSON format", alias="yandexWarmupPlan")
    gmx_warmup_plan: Optional[StrictStr] = Field(default=None, description="GMX warmup plan configuration in JSON format", alias="gmxWarmupPlan")
    mailru_warmup_plan: Optional[StrictStr] = Field(default=None, description="Mail.ru warmup plan configuration in JSON format", alias="mailruWarmupPlan")
    icloud_warmup_plan: Optional[StrictStr] = Field(default=None, description="iCloud warmup plan configuration in JSON format", alias="icloudWarmupPlan")
    zoho_warmup_plan: Optional[StrictStr] = Field(default=None, description="Zoho warmup plan configuration in JSON format", alias="zohoWarmupPlan")
    qq_warmup_plan: Optional[StrictStr] = Field(default=None, description="QQ warmup plan configuration in JSON format", alias="qqWarmupPlan")
    default_warmup_plan: Optional[StrictStr] = Field(default=None, description="Default warmup plan configuration in JSON format", alias="defaultWarmupPlan")
    att_warmup_plan: Optional[StrictStr] = Field(default=None, description="AT&T warmup plan configuration in JSON format", alias="attWarmupPlan")
    office365_warmup_plan: Optional[StrictStr] = Field(default=None, description="Office365 warmup plan configuration in JSON format", alias="office365WarmupPlan")
    googleworkspace_warmup_plan: Optional[StrictStr] = Field(default=None, description="Google Workspace warmup plan configuration in JSON format", alias="googleworkspaceWarmupPlan")
    proofpoint_warmup_plan: Optional[StrictStr] = Field(default=None, description="Proofpoint warmup plan configuration in JSON format", alias="proofpointWarmupPlan")
    mimecast_warmup_plan: Optional[StrictStr] = Field(default=None, description="Mimecast warmup plan configuration in JSON format", alias="mimecastWarmupPlan")
    barracuda_warmup_plan: Optional[StrictStr] = Field(default=None, description="Barracuda warmup plan configuration in JSON format", alias="barracudaWarmupPlan")
    ciscoironport_warmup_plan: Optional[StrictStr] = Field(default=None, description="Cisco IronPort warmup plan configuration in JSON format", alias="ciscoironportWarmupPlan")
    rackspace_warmup_plan: Optional[StrictStr] = Field(default=None, description="Rackspace warmup plan configuration in JSON format", alias="rackspaceWarmupPlan")
    zohobusiness_warmup_plan: Optional[StrictStr] = Field(default=None, description="Zoho Business warmup plan configuration in JSON format", alias="zohobusinessWarmupPlan")
    amazonworkmail_warmup_plan: Optional[StrictStr] = Field(default=None, description="Amazon WorkMail warmup plan configuration in JSON format", alias="amazonworkmailWarmupPlan")
    symantec_warmup_plan: Optional[StrictStr] = Field(default=None, description="Symantec warmup plan configuration in JSON format", alias="symantecWarmupPlan")
    fortinet_warmup_plan: Optional[StrictStr] = Field(default=None, description="Fortinet warmup plan configuration in JSON format", alias="fortinetWarmupPlan")
    sophos_warmup_plan: Optional[StrictStr] = Field(default=None, description="Sophos warmup plan configuration in JSON format", alias="sophosWarmupPlan")
    trendmicro_warmup_plan: Optional[StrictStr] = Field(default=None, description="Trend Micro warmup plan configuration in JSON format", alias="trendmicroWarmupPlan")
    checkpoint_warmup_plan: Optional[StrictStr] = Field(default=None, description="Checkpoint warmup plan configuration in JSON format", alias="checkpointWarmupPlan")
    created: Optional[StrictInt] = Field(default=None, description="UNIX epoch nano timestamp when the warmup plan was created")
    updated: Optional[StrictInt] = Field(default=None, description="UNIX epoch nano timestamp when the warmup plan was last updated")
    warmup_interval: Optional[StrictInt] = Field(default=None, description="Warmup interval in hours", alias="warmupInterval")
    __properties: ClassVar[List[str]] = ["id", "name", "gmailWarmupPlan", "yahooWarmupPlan", "aolWarmupPlan", "microsoftWarmupPlan", "comcastWarmupPlan", "yandexWarmupPlan", "gmxWarmupPlan", "mailruWarmupPlan", "icloudWarmupPlan", "zohoWarmupPlan", "qqWarmupPlan", "defaultWarmupPlan", "attWarmupPlan", "office365WarmupPlan", "googleworkspaceWarmupPlan", "proofpointWarmupPlan", "mimecastWarmupPlan", "barracudaWarmupPlan", "ciscoironportWarmupPlan", "rackspaceWarmupPlan", "zohobusinessWarmupPlan", "amazonworkmailWarmupPlan", "symantecWarmupPlan", "fortinetWarmupPlan", "sophosWarmupPlan", "trendmicroWarmupPlan", "checkpointWarmupPlan", "created", "updated", "warmupInterval"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "gmailWarmupPlan": obj.get("gmailWarmupPlan"),
            "yahooWarmupPlan": obj.get("yahooWarmupPlan"),
            "aolWarmupPlan": obj.get("aolWarmupPlan"),
            "microsoftWarmupPlan": obj.get("microsoftWarmupPlan"),
            "comcastWarmupPlan": obj.get("comcastWarmupPlan"),
            "yandexWarmupPlan": obj.get("yandexWarmupPlan"),
            "gmxWarmupPlan": obj.get("gmxWarmupPlan"),
            "mailruWarmupPlan": obj.get("mailruWarmupPlan"),
            "icloudWarmupPlan": obj.get("icloudWarmupPlan"),
            "zohoWarmupPlan": obj.get("zohoWarmupPlan"),
            "qqWarmupPlan": obj.get("qqWarmupPlan"),
            "defaultWarmupPlan": obj.get("defaultWarmupPlan"),
            "attWarmupPlan": obj.get("attWarmupPlan"),
            "office365WarmupPlan": obj.get("office365WarmupPlan"),
            "googleworkspaceWarmupPlan": obj.get("googleworkspaceWarmupPlan"),
            "proofpointWarmupPlan": obj.get("proofpointWarmupPlan"),
            "mimecastWarmupPlan": obj.get("mimecastWarmupPlan"),
            "barracudaWarmupPlan": obj.get("barracudaWarmupPlan"),
            "ciscoironportWarmupPlan": obj.get("ciscoironportWarmupPlan"),
            "rackspaceWarmupPlan": obj.get("rackspaceWarmupPlan"),
            "zohobusinessWarmupPlan": obj.get("zohobusinessWarmupPlan"),
            "amazonworkmailWarmupPlan": obj.get("amazonworkmailWarmupPlan"),
            "symantecWarmupPlan": obj.get("symantecWarmupPlan"),
            "fortinetWarmupPlan": obj.get("fortinetWarmupPlan"),
            "sophosWarmupPlan": obj.get("sophosWarmupPlan"),
            "trendmicroWarmupPlan": obj.get("trendmicroWarmupPlan"),
            "checkpointWarmupPlan": obj.get("checkpointWarmupPlan"),
