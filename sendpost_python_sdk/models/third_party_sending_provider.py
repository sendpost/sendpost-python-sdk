...
class ThirdPartySendingProvider(BaseModel):
    """
    ...
    oauth_token: Optional[StrictStr] = Field(default=None, alias="oauthToken")
    retry_time: Optional[StrictInt] = Field(default=None, alias="retryTime")
    created: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "name", "type", "domain", "endpoint", "key", "secret", "port", "oauthToken", "retryTime", "created"]
