...
class CreateWebhookRequest(BaseModel):
    ...
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Is the webhook active or in a paused state?")
    url: Optional[StrictStr] = Field(default=None, description="URL endpoint to which webhook calls are sent.")
    ...
    __properties: ClassVar[List[str]] = ["enabled", "url", "processed", "delivered", "dropped", "softBounced", "hardBounced", "opened", "clicked", "unsubscribed", "spam", "sent", "smtpDropped", "uniqueOpen", "uniqueClick"]
