...
class Member(BaseModel):
    ...
    Member
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique ID for the member")
    is_verified: Optional[StrictBool] = Field(default=None, description="Indicates whether the member is verified", alias="isVerified")
    is_forbidden: Optional[StrictBool] = Field(default=None, description="Indicates whether the member is forbidden", alias="isForbidden")
    firebase_uid: Optional[StrictStr] = Field(default=None, description="Firebase UID for the member", alias="firebaseUID")
    email: Optional[StrictStr] = Field(default=None, description="Email for the member")
    name: Optional[StrictStr] = Field(default=None, description="Name for the member")
    url: Optional[StrictStr] = Field(default=None, description="Logo URL for the member")
    company_name: Optional[StrictStr] = Field(default=None, description="Company name for the member", alias="companyName")
    onboard_q_answered: Optional[StrictBool] = Field(default=None, description="Indicates whether the member has answered onboarding question", alias="onboardQAnswered")
    phone_number: Optional[StrictStr] = Field(default=None, description="Phone number for the member", alias="phoneNumber")
    notes_color: Optional[StrictStr] = Field(default=None, description="Color for the member's notes", alias="notesColor")
    created: Optional[StrictInt] = Field(default=None, description="UNIX epoch nano timestamp when the member was created")
    __properties: ClassVar[List[str]] = ["id", "isVerified", "isForbidden", "firebaseUID", "email", "name", "url", "companyName", "onboardQAnswered", "phoneNumber", "notesColor", "created"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firebaseUID": obj.get("firebaseUID"),
            "email": obj.get("email"),
            "name": obj.get("name"),
            "url": obj.get("url"),
            "companyName": obj.get("companyName"),
            "onboardQAnswered": obj.get("onboardQAnswered"),
            "phoneNumber": obj.get("phoneNumber"),
            "notesColor": obj.get("notesColor"),
