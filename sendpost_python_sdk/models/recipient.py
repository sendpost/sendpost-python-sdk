...
class Recipient(BaseModel):
    ...
    cc: Optional[List[CopyTo]] = None
    bcc: Optional[List[CopyTo]] = None
    custom_fields: Optional[Dict[str, Any]] = Field(default=None, description="Custom fields for personalization", alias="customFields")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "name": obj.get("name"),
            "cc": [CopyTo.from_dict(_item) for _item in obj["cc"]] if obj.get("cc") is not None else None,
            "bcc": [CopyTo.from_dict(_item) for _item in obj["bcc"]] if obj.get("bcc") is not None else None,
