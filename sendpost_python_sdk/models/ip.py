...
class IP(BaseModel):
    ...
    yahoo_settings: Optional[StrictStr] = Field(default=None, description="Configuration for Yahoo delivery settings in JSON format", alias="yahooSettings")
    aol_settings: Optional[StrictStr] = Field(default=None, description="Configuration for AOL delivery settings in JSON format", alias="aolSettings")
    microsoft_settings: Optional[StrictStr] = Field(default=None, description="Configuration for Microsoft delivery settings in JSON format", alias="microsoftSettings")
    comcast_settings: Optional[StrictStr] = Field(default=None, description="Configuration for Comcast delivery settings in JSON format", alias="comcastSettings")
    yandex_settings: Optional[StrictStr] = Field(default=None, description="Configuration for Yandex delivery settings in JSON format", alias="yandexSettings")
    gmx_settings: Optional[StrictStr] = Field(default=None, description="Configuration for GMX delivery settings in JSON format", alias="gmxSettings")
    mailru_settings: Optional[StrictStr] = Field(default=None, description="Configuration for Mail.ru delivery settings in JSON format", alias="mailruSettings")
    icloud_settings: Optional[StrictStr] = Field(default=None, description="Configuration for iCloud delivery settings in JSON format", alias="icloudSettings")
    zoho_settings: Optional[StrictStr] = Field(default=None, description="Configuration for Zoho delivery settings in JSON format", alias="zohoSettings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "systemDomain": Domain.from_dict(obj["systemDomain"]) if obj.get("systemDomain") is not None else None,
            "reverseDNSHostname": obj.get("reverseDNSHostname"),
            "type": obj.get("type"),
            "gmailSettings": obj.get("gmailSettings"),
            "yahooSettings": obj.get("yahooSettings"),
            "aolSettings": obj.get("aolSettings"),
            "microsoftSettings": obj.get("microsoftSettings"),
            "comcastSettings": obj.get("comcastSettings"),
            "yandexSettings": obj.get("yandexSettings"),
            "gmxSettings": obj.get("gmxSettings"),
            "mailruSettings": obj.get("mailruSettings"),
            "icloudSettings": obj.get("icloudSettings"),
            "zohoSettings": obj.get("zohoSettings"),
