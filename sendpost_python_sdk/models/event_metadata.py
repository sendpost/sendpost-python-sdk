...
class EventMetadata(BaseModel):
    ...
    user_agent: Optional[UserAgent] = Field(default=None, alias="userAgent")
    os: Optional[OperatingSystem] = None
    device: Optional[Device] = None
    geo: Optional[GeoLocation] = None
    clicked_url: Optional[StrictStr] = Field(default=None, alias="clickedURL")
    tracked_ip: Optional[StrictStr] = Field(default=None, alias="trackedIP")
    raw_user_agent: Optional[StrictStr] = Field(default=None, alias="rawUserAgent")
    __properties: ClassVar[List[str]] = ["smtpCode", "smtpDescription", "userAgent", "os", "device", "geo", "clickedURL", "trackedIP", "rawUserAgent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userAgent": UserAgent.from_dict(obj["userAgent"]) if obj.get("userAgent") is not None else None,
            ...
            "geo": GeoLocation.from_dict(obj["geo"]) if obj.get("geo") is not None else None,
            "clickedURL": obj.get("clickedURL"),
            "trackedIP": obj.get("trackedIP"),
