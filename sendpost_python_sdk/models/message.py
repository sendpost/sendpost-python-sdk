...
class Message(BaseModel):
    ...
    Message
    """ # noqa: E501
    message_id: Optional[StrictStr] = Field(default=None, description="Unique ID for the message.", alias="messageID")
    account_id: Optional[StrictInt] = Field(default=None, description="Account ID associated with the message.", alias="accountID")
    sub_account_id: Optional[StrictInt] = Field(default=None, description="Sub-account ID associated with the message.", alias="subAccountID")
    ip_id: Optional[StrictInt] = Field(default=None, description="IP ID used for sending the message.", alias="ipID")
    account_ip_pool_id: Optional[StrictInt] = Field(default=None, description="Account IP Pool ID associated with the message.", alias="accountIPPoolID")
    public_ip: Optional[StrictStr] = Field(default=None, description="Public IP address used for sending the message.", alias="publicIP")
    ...
    header_bcc: Optional[List[StrictStr]] = Field(default=None, description="List of BCC recipients from email headers", alias="headerBcc")
    attachments: Optional[List[StrictStr]] = Field(default=None, description="List of attachments")
    groups: Optional[List[StrictStr]] = Field(default=None, description="List of groups associated with the message")
    ip_pool: Optional[StrictStr] = Field(default=None, description="IP Pool from which emails will go out. Relevant only for customers on dedicated IP plans.", alias="ipPool")
    headers: Optional[Dict[str, StrictStr]] = Field(default=None, description="Key-Value pair which are added to every email message being sent and also with webhooks triggered on events such as email delivered, open, click etc. They are useful to identify email, recipient etc. in your internal system")
    custom_fields: Optional[Dict[str, StrictStr]] = Field(default=None, description="Key-Value pair of custom fields at message level", alias="customFields")
    subject: Optional[StrictStr] = Field(default=None, description="Email subject line.")
    pre_text: Optional[StrictStr] = Field(default=None, description="Text which appears on mobile right after email subject line.", alias="preText")
    html_body: Optional[StrictStr] = Field(default=None, description="HTML email content.", alias="htmlBody")
    text_body: Optional[StrictStr] = Field(default=None, description="Text email content.", alias="textBody")
    amp_body: Optional[StrictStr] = Field(default=None, description="AMP email content.", alias="ampBody")
    track_opens: Optional[StrictBool] = Field(default=None, description="Indicates if email opens need to be tracked.", alias="trackOpens")
    track_clicks: Optional[StrictBool] = Field(default=None, description="Indicates if email clicks need to be tracked.", alias="trackClicks")
    attempt: Optional[StrictInt] = Field(default=None, description="Number of delivery attempts made for the message.")
    webhook_endpoint: Optional[StrictStr] = Field(default=None, description="Webhook endpoint URL for the message.", alias="webhookEndpoint")
    mx_records: Optional[List[StrictStr]] = Field(default=None, description="List of MX records for the recipient domain", alias="mxRecords")
    __properties: ClassVar[List[str]] = ["messageID", "accountID", "subAccountID", "ipID", "accountIPPoolID", "publicIP", "localIP", "emailType", "submittedAt", "from", "replyTo", "to", "headerTo", "headerCc", "headerBcc", "attachments", "groups", "ipPool", "headers", "customFields", "subject", "preText", "htmlBody", "textBody", "ampBody", "trackOpens", "trackClicks", "attempt", "webhookEndpoint", "mxRecords"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of header_to
        if self.header_to:
            _dict['headerTo'] = self.header_to.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipID": obj.get("ipID"),
            "accountIPPoolID": obj.get("accountIPPoolID"),
            "publicIP": obj.get("publicIP"),
            "localIP": obj.get("localIP"),
            "emailType": obj.get("emailType"),
            "submittedAt": obj.get("submittedAt"),
            "from": Person.from_dict(obj["from"]) if obj.get("from") is not None else None,
            "replyTo": Person.from_dict(obj["replyTo"]) if obj.get("replyTo") is not None else None,
            "to": MessageTo.from_dict(obj["to"]) if obj.get("to") is not None else None,
            "headerTo": MessageHeaderTo.from_dict(obj["headerTo"]) if obj.get("headerTo") is not None else None,
            "headerCc": obj.get("headerCc"),
            "headerBcc": obj.get("headerBcc"),
