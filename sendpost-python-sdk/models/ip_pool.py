...
class IPPool(BaseModel):
    ...
    third_party_sending_providers: Optional[List[ThirdPartySendingProvider]] = Field(default=None, alias="thirdPartySendingProviders")
    ...
    auto_warmup_enabled: Optional[StrictBool] = Field(default=None, alias="autoWarmupEnabled")
    infra_monitor: Optional[StrictBool] = Field(default=None, alias="infraMonitor")
    ip_domain_warmup_status: Optional[StrictStr] = Field(default=None, alias="ipDomainWarmupStatus")
    should_overflow: Optional[StrictBool] = Field(default=None, description="Indicates whether the IP should overflow, once email capacity of the IP Pool has been reached, should we send remaining emails over shared IP or not", alias="shouldOverflow")
    overflow_pool_name: Optional[StrictStr] = Field(default=None, description="The name of the overflow pool", alias="overflowPoolName")
    warmup_interval: Optional[StrictInt] = Field(default=None, description="The interval for the warmup", alias="warmupInterval")
    __properties: ClassVar[List[str]] = ["id", "name", "created", "ips", "thirdPartySendingProviders", "routingStrategy", "routingMetaData", "autoWarmupEnabled", "infraMonitor", "ipDomainWarmupStatus", "shouldOverflow", "overflowPoolName", "warmupInterval"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.ips:
            ...
            _dict['ips'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in third_party_sending_providers (list)
        _items = []
        if self.third_party_sending_providers:
            for _item_third_party_sending_providers in self.third_party_sending_providers:
                if _item_third_party_sending_providers:
                    _items.append(_item_third_party_sending_providers.to_dict())
            _dict['thirdPartySendingProviders'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ips": [IP.from_dict(_item) for _item in obj["ips"]] if obj.get("ips") is not None else None,
            "thirdPartySendingProviders": [ThirdPartySendingProvider.from_dict(_item) for _item in obj["thirdPartySendingProviders"]] if obj.get("thirdPartySendingProviders") is not None else None,
            "routingStrategy": obj.get("routingStrategy"),
            "routingMetaData": obj.get("routingMetaData"),
            "autoWarmupEnabled": obj.get("autoWarmupEnabled"),
            "infraMonitor": obj.get("infraMonitor"),
            "ipDomainWarmupStatus": obj.get("ipDomainWarmupStatus"),
            "shouldOverflow": obj.get("shouldOverflow"),
