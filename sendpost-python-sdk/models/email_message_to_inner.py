...
class EmailMessageToInner(BaseModel):
    """
    EmailMessageToInner
    """ # noqa: E501
    ...
    cc: Optional[List[EmailMessageToInnerCcInner]] = None
    bcc: Optional[List[EmailMessageToInnerBccInner]] = None
    __properties: ClassVar[List[str]] = ["name", "email", "customFields", "cc", "bcc"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cc": [EmailMessageToInnerCcInner.from_dict(_item) for _item in obj["cc"]] if obj.get("cc") is not None else None,
            "bcc": [EmailMessageToInnerBccInner.from_dict(_item) for _item in obj["bcc"]] if obj.get("bcc") is not None else None
        })
        return _obj
