...
class EmailMessageObject(BaseModel):
    """
    EmailMessageObject
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["from", "replyTo", "to", "subject", "preText", "htmlBody", "textBody", "ampBody", "ippool", "headers", "trackOpens", "trackClicks", "groups", "attachments", "webhookEndpoint"]
