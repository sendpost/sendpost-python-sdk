...
class AccountStatsStat(BaseModel):
    """
    AccountStatsStat
    """ # noqa: E501
    ...
    smtp_dropped: Optional[StrictInt] = Field(default=None, alias="smtpDropped")
    hard_bounced: Optional[StrictInt] = Field(default=None, alias="hardBounced")
    soft_bounced: Optional[StrictInt] = Field(default=None, alias="softBounced")
    opened: Optional[StrictInt] = None
    clicked: Optional[StrictInt] = None
    unsubscribed: Optional[StrictInt] = None
    spams: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["processed", "sent", "delivered", "dropped", "smtpDropped", "hardBounced", "softBounced", "opened", "clicked", "unsubscribed", "spams"]
