...
class Event(BaseModel):
    ...
    ip_pool_id: Optional[StrictInt] = Field(default=None, alias="ipPoolID")
    domain_id: Optional[StrictInt] = Field(default=None, alias="domainID")
    tpsp_id: Optional[StrictInt] = Field(default=None, alias="tpspId")
    message_type: Optional[StrictStr] = Field(default=None, alias="messageType")
    message_subject: Optional[StrictStr] = Field(default=None, alias="messageSubject")
    ...
    smtp_code: Optional[StrictInt] = Field(default=None, alias="smtpCode")
    smtp_description: Optional[StrictStr] = Field(default=None, alias="smtpDescription")
    event_metadata: Optional[EventMetadata] = Field(default=None, alias="eventMetadata")
    __properties: ClassVar[List[str]] = ["eventID", "groups", "ipID", "ipPoolID", "domainID", "tpspId", "messageType", "messageSubject", "accountID", "subAccountID", "messageID", "type", "from", "fromName", "to", "toName", "submittedAt", "smtpCode", "smtpDescription", "eventMetadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipID": obj.get("ipID"),
            "ipPoolID": obj.get("ipPoolID"),
            "domainID": obj.get("domainID"),
            "tpspId": obj.get("tpspId"),
            ...
            "smtpCode": obj.get("smtpCode"),
            "smtpDescription": obj.get("smtpDescription"),
            "eventMetadata": EventMetadata.from_dict(obj["eventMetadata"]) if obj.get("eventMetadata") is not None else None
        })
        return _obj
