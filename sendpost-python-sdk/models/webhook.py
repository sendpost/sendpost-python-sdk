...
class Webhook(BaseModel):
    ...
    Webhook
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique ID for the webhook.")
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates if the webhook is active or paused.")
    url: Optional[StrictStr] = Field(default=None, description="URL endpoint to which webhook calls need to be made.")
    processed: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message being processed.")
    delivered: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message being delivered.")
    dropped: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message being dropped.")
    soft_bounced: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message being soft bounced.", alias="softBounced")
    hard_bounced: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message being hard bounced.", alias="hardBounced")
    opened: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message being opened.")
    clicked: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message link being clicked.")
    unsubscribed: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message being unsubscribed.")
    spam: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message being marked as spam.")
    sent: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message being sent.")
    smtp_dropped: Optional[StrictBool] = Field(default=None, description="Trigger webhook on email message being dropped by SMTP.", alias="smtpDropped")
    unique_open: Optional[StrictBool] = Field(default=None, description="Trigger webhook on unique email opens.", alias="uniqueOpen")
    unique_click: Optional[StrictBool] = Field(default=None, description="Trigger webhook on unique email clicks.", alias="uniqueClick")
    created: Optional[StrictInt] = Field(default=None, description="UNIX epoch nano timestamp when the webhook was created.")
    created_by: Optional[Dict[str, Any]] = Field(default=None, description="Member who created the webhook")
    updated_by: Optional[Dict[str, Any]] = Field(default=None, description="Member who updated the webhook")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "enabled", "url", "processed", "delivered", "dropped", "softBounced", "hardBounced", "opened", "clicked", "unsubscribed", "spam", "sent", "smtpDropped", "uniqueOpen", "uniqueClick", "created", "created_by", "updated_by"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uniqueOpen": obj.get("uniqueOpen"),
            "uniqueClick": obj.get("uniqueClick"),
