...
class AggregatedEmailStats(BaseModel):
    """
    AggregatedEmailStats
    """ # noqa: E501
    processed: Optional[StrictInt] = Field(default=None, description="Total number of emails accepted by SendPost API")
    sent: Optional[StrictInt] = Field(default=None, description="Total number of emails sent")
    delivered: Optional[StrictInt] = Field(default=None, description="Total number of emails successfully delivered to SMTP")
    dropped: Optional[StrictInt] = Field(default=None, description="Total number of emails dropped without delivery")
    smtp_dropped: Optional[StrictInt] = Field(default=None, description="Total number of emails dropped by SMTP", alias="smtpDropped")
    hard_bounced: Optional[StrictInt] = Field(default=None, description="Total number of hard bounce errors", alias="hardBounced")
    soft_bounced: Optional[StrictInt] = Field(default=None, description="Total number of soft bounce errors", alias="softBounced")
    opened: Optional[StrictInt] = Field(default=None, description="Total number of emails opened by recipients")
    clicked: Optional[StrictInt] = Field(default=None, description="Total number of links clicked by recipients")
    unsubscribed: Optional[StrictInt] = Field(default=None, description="Total number of unsubscribed recipients")
    spam: Optional[StrictInt] = Field(default=None, description="Total number of spams reported by recipients")
