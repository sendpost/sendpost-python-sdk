...
from sendpost-python-sdk.models.email_message_reply_to import EmailMessageReplyTo
...
class EmailMessage(BaseModel):
    ...
    ip_id: Optional[StrictInt] = Field(default=None, alias="ipID")
    public_ip: Optional[StrictStr] = Field(default=None, alias="publicIP")
    local_ip: Optional[StrictStr] = Field(default=None, alias="localIP")
    email_type: Optional[StrictStr] = Field(default=None, alias="emailType")
    submitted_at: Optional[StrictInt] = Field(default=None, alias="submittedAt")
    var_from: Optional[EmailMessageFrom] = Field(default=None, alias="from")
    reply_to: Optional[EmailMessageReplyTo] = Field(default=None, alias="replyTo")
    to: Optional[List[EmailMessageToInner]] = None
    groups: Optional[List[StrictStr]] = None
    ip_pool: Optional[StrictStr] = Field(default=None, alias="ipPool")
    ...
    __properties: ClassVar[List[str]] = ["messageID", "accountID", "subAccountID", "ipID", "publicIP", "localIP", "emailType", "submittedAt", "from", "replyTo", "to", "groups", "ipPool", "headers", "customFields", "trackOpens", "trackClicks", "webhookEndpoint"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": EmailMessageFrom.from_dict(obj["from"]) if obj.get("from") is not None else None,
            "replyTo": EmailMessageReplyTo.from_dict(obj["replyTo"]) if obj.get("replyTo") is not None else None,
            "to": [EmailMessageToInner.from_dict(_item) for _item in obj["to"]] if obj.get("to") is not None else None,
