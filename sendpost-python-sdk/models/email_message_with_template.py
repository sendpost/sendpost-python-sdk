...
from sendpost-python-sdk.models.attachment import Attachment
from sendpost-python-sdk.models.email_address import EmailAddress
from sendpost-python-sdk.models.recipient import Recipient
from typing import Optional, Set
from typing_extensions import Self

class EmailMessageWithTemplate(BaseModel):
    """
    EmailMessageWithTemplate
    """ # noqa: E501
    var_from: Optional[EmailAddress] = Field(default=None, alias="from")
    reply_to: Optional[EmailAddress] = Field(default=None, alias="replyTo")
    ...
    amp_body: Optional[StrictStr] = Field(default=None, alias="ampBody")
    ippool: Optional[StrictStr] = None
    headers: Optional[Dict[str, StrictStr]] = None
    track_opens: Optional[StrictBool] = Field(default=None, alias="trackOpens")
    track_clicks: Optional[StrictBool] = Field(default=None, alias="trackClicks")
    ...
    template_id: Optional[StrictStr] = Field(default=None, description="Template ID for the email template", alias="templateId")
    template_variables: Optional[Dict[str, StrictStr]] = Field(default=None, description="Key-Value pair of template variables", alias="templateVariables")
    __properties: ClassVar[List[str]] = ["from", "replyTo", "to", "subject", "preText", "htmlBody", "textBody", "ampBody", "ippool", "headers", "trackOpens", "trackClicks", "groups", "attachments", "webhookEndpoint", "template", "templateId", "templateVariables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from": EmailAddress.from_dict(obj["from"]) if obj.get("from") is not None else None,
            "replyTo": EmailAddress.from_dict(obj["replyTo"]) if obj.get("replyTo") is not None else None,
            ...
            "templateVariables": obj.get("templateVariables")
        })
        return _obj
