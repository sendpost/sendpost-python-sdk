...
class SuppressionApi:
    ...
    def create_suppression(
        self,
        create_suppression_request: CreateSuppressionRequest,
        ...
        :param create_suppression_request: (required)
        :type create_suppression_request: CreateSuppressionRequest
        ...
        _param = self._create_suppression_serialize(
            create_suppression_request=create_suppression_request,
    ...
    @validate_call
    def create_suppression_with_http_info(
        self,
        create_suppression_request: CreateSuppressionRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_suppression_without_preload_content(
        self,
        create_suppression_request: CreateSuppressionRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_suppression_serialize(
        self,
        ...
        if create_suppression_request is not None:
            _body_params = create_suppression_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subaccount/suppression',
    ...
    def delete_suppression(
        self,
        delete_suppression_request: DeleteSuppressionRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[DeleteSuppression200ResponseInner]:
        """Delete Suppressions
        ...
        :param delete_suppression_request: (required)
        :type delete_suppression_request: DeleteSuppressionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_suppression_serialize(
            delete_suppression_request=delete_suppression_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[DeleteSuppression200ResponseInner]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def delete_suppression_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DeleteSuppression200ResponseInner]]:
        """Delete Suppressions
    ...
    @validate_call
    def delete_suppression_without_preload_content(
        self,
        delete_suppression_request: DeleteSuppressionRequest,
        _request_timeout: Union[
            None,
    ...
    def _delete_suppression_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if delete_suppression_request is not None:
            _body_params = delete_suppression_request
    ...
    def get_suppression_list(
        self,
        var_from: Annotated[date, Field(description="Start date for the suppression records")],
        to: Annotated[date, Field(description="End date for the suppression records (Note: `from` should be earlier than `to` and the date range should not exceed 60 days) ")],
        limit: Annotated[Optional[StrictInt], Field(description="Number of records to return per request")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Number of initial records to skip")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Case-insensitive search against suppression email")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Type of suppression. Valid values: `hardBounce`, `manual`, `spamComplaint`, `unsubscribe` ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param var_from: Start date for the suppression records (required)
        :type var_from: date
        ...
        :type to: date
        :param limit: Number of records to return per request
        :type limit: int
        :param offset: Number of initial records to skip
        :type offset: int
        :param search: Case-insensitive search against suppression email
        :type search: str
        :param type: Type of suppression. Valid values: `hardBounce`, `manual`, `spamComplaint`, `unsubscribe` 
        :type type: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_suppression_list_serialize(
            var_from=var_from,
            to=to,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def get_suppression_list_with_http_info(
        self,
        var_from: Annotated[date, Field(description="Start date for the suppression records")],
        to: Annotated[date, Field(description="End date for the suppression records (Note: `from` should be earlier than `to` and the date range should not exceed 60 days) ")],
        limit: Annotated[Optional[StrictInt], Field(description="Number of records to return per request")] = None,
    ...
    @validate_call
    def get_suppression_list_without_preload_content(
        self,
        var_from: Annotated[date, Field(description="Start date for the suppression records")],
        to: Annotated[date, Field(description="End date for the suppression records (Note: `from` should be earlier than `to` and the date range should not exceed 60 days) ")],
        limit: Annotated[Optional[StrictInt], Field(description="Number of records to return per request")] = None,
    ...
    def _get_suppression_list_serialize(
        self,
        var_from,
        to,
        limit,
