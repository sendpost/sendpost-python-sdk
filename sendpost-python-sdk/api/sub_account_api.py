...
class SubAccountApi:
    ...
    @validate_call
    def create_sub_account_with_http_info(
        self,
        create_sub_account_request: CreateSubAccountRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_sub_account_without_preload_content(
        self,
        create_sub_account_request: CreateSubAccountRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_sub_account_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/account/subaccount/',
    ...
    def delete_sub_account(
        self,
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the sub-account to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param subaccount_id: The ID of the sub-account to delete. (required)
    ...
    @validate_call
    def delete_sub_account_with_http_info(
        self,
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the sub-account to delete.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteSubAccountResponse]:
        """Delete Sub-Account
    ...
    @validate_call
    def delete_sub_account_without_preload_content(
        self,
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the sub-account to delete.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_sub_account_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/account/subaccount/{subaccount_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_sub_accounts(
        ...
        search: Annotated[Optional[StrictStr], Field(description="Case-insensitive search against the sub-account name.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type offset: int
        :param search: Case-insensitive search against the sub-account name.
        :type search: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_all_sub_accounts_serialize(
            limit=limit,
            offset=offset,
            search=search,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_all_sub_accounts_with_http_info(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Number of records to return per request.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Number of initial records to skip.")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Case-insensitive search against the sub-account name.")] = None,
    ...
    @validate_call
    def get_all_sub_accounts_without_preload_content(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Number of records to return per request.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Number of initial records to skip.")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Case-insensitive search against the sub-account name.")] = None,
    ...
    def _get_all_sub_accounts_serialize(
        self,
        limit,
        offset,
        search,
    ...
    def get_sub_account(
        self,
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the sub-account to retrieve.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param subaccount_id: The ID of the sub-account to retrieve. (required)
        :type subaccount_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_sub_account_serialize(
            subaccount_id=subaccount_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_sub_account_with_http_info(
        self,
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the sub-account to retrieve.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_sub_account_without_preload_content(
        self,
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the sub-account to retrieve.")],
        _request_timeout: Union[
            None,
    ...
    def _get_sub_account_serialize(
        self,
        subaccount_id,
        _request_auth,
        _content_type,
    ...
    def update_sub_account(
        self,
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the sub-account to update.")],
        update_sub_account: UpdateSubAccount,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param subaccount_id: The ID of the sub-account to update. (required)
        :type subaccount_id: int
        :param update_sub_account: (required)
        :type update_sub_account: UpdateSubAccount
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_sub_account_serialize(
            subaccount_id=subaccount_id,
    ...
    @validate_call
    def update_sub_account_with_http_info(
        self,
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the sub-account to update.")],
        update_sub_account: UpdateSubAccount,
        _request_timeout: Union[
    ...
    @validate_call
    def update_sub_account_without_preload_content(
        self,
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the sub-account to update.")],
        update_sub_account: UpdateSubAccount,
        _request_timeout: Union[
    ...
    def _update_sub_account_serialize(
        self,
        subaccount_id,
        update_sub_account,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if update_sub_account is not None:
            _body_params = update_sub_account
