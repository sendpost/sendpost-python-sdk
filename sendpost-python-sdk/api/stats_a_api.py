...
from sendpost-python-sdk.api_client import ApiClient, RequestSerialized
from sendpost-python-sdk.api_response import ApiResponse
from sendpost-python-sdk.rest import RESTResponseType
...
class StatsAApi:
    ...
    @validate_call
    def get_account_aggregate_stats(
        self,
        var_from: Annotated[date, Field(description="The start date for retrieving aggregated stats (inclusive)")],
        to: Annotated[date, Field(description="The end date for retrieving aggregated stats (inclusive). The difference between `from` and `to` should not exceed 366 days.")],
        ...
        :param var_from: The start date for retrieving aggregated stats (inclusive) (required)
        :type var_from: date
        :param to: The end date for retrieving aggregated stats (inclusive). The difference between `from` and `to` should not exceed 366 days. (required)
        :type to: date
        ...
        _param = self._get_account_aggregate_stats_serialize(
            var_from=var_from,
            to=to,
    ...
    @validate_call
    def get_account_aggregate_stats_with_http_info(
        self,
        var_from: Annotated[date, Field(description="The start date for retrieving aggregated stats (inclusive)")],
        to: Annotated[date, Field(description="The end date for retrieving aggregated stats (inclusive). The difference between `from` and `to` should not exceed 366 days.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_account_aggregate_stats_without_preload_content(
        self,
        var_from: Annotated[date, Field(description="The start date for retrieving aggregated stats (inclusive)")],
        to: Annotated[date, Field(description="The end date for retrieving aggregated stats (inclusive). The difference between `from` and `to` should not exceed 366 days.")],
        _request_timeout: Union[
    ...
    def _get_account_aggregate_stats_serialize(
        self,
        var_from,
        to,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/stat/aggregate',
    ...
    @validate_call
    def get_account_aggregate_stats_by_group(
        self,
        group: Annotated[StrictStr, Field(description="Group whose aggregate stats need to be retrieved.")],
        var_from: Annotated[date, Field(description="Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`).")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 366 days.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type group: str
        :param var_from: Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`). (required)
        :type var_from: date
        :param to: Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 366 days. (required)
        :type to: date
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_account_aggregate_stats_by_group_serialize(
            group=group,
            var_from=var_from,
            to=to,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_account_aggregate_stats_by_group_with_http_info(
        self,
        group: Annotated[StrictStr, Field(description="Group whose aggregate stats need to be retrieved.")],
        var_from: Annotated[date, Field(description="Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`).")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 366 days.")],
    ...
    @validate_call
    def get_account_aggregate_stats_by_group_without_preload_content(
        self,
        group: Annotated[StrictStr, Field(description="Group whose aggregate stats need to be retrieved.")],
        var_from: Annotated[date, Field(description="Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`).")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 366 days.")],
    ...
    def _get_account_aggregate_stats_by_group_serialize(
        self,
        group,
        var_from,
        to,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/stat/aggregate/group',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_account_stats_by_group(
        self,
        group: Annotated[StrictStr, Field(description="Group whose stats need to be retrieved")],
        var_from: Annotated[date, Field(description="Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`)")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 31 days.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param var_from: Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`) (required)
        :type var_from: date
        :param to: Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 31 days. (required)
        :type to: date
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_account_stats_by_group_serialize(
            group=group,
            var_from=var_from,
            to=to,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_account_stats_by_group_with_http_info(
        self,
        group: Annotated[StrictStr, Field(description="Group whose stats need to be retrieved")],
        var_from: Annotated[date, Field(description="Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`)")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 31 days.")],
    ...
    @validate_call
    def get_account_stats_by_group_without_preload_content(
        self,
        group: Annotated[StrictStr, Field(description="Group whose stats need to be retrieved")],
        var_from: Annotated[date, Field(description="Date from which stats should be retrieved (should be in the format `YYYY-MM-DD`)")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved (should be in the format `YYYY-MM-DD`). Note that the difference between `from` and `to` should not be more than 31 days.")],
    ...
    def _get_account_stats_by_group_serialize(
        self,
        group,
        var_from,
        to,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/stat/group',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_account_stats(
        self,
        var_from: Annotated[date, Field(description="The start date for retrieving stats (inclusive)")],
        to: Annotated[date, Field(description="The end date for retrieving stats (inclusive). The difference between `from` and `to` should not exceed 31 days.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param var_from: The start date for retrieving stats (inclusive) (required)
        :type var_from: date
        ...
        _param = self._get_all_account_stats_serialize(
            var_from=var_from,
            to=to,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_all_account_stats_with_http_info(
        self,
        var_from: Annotated[date, Field(description="The start date for retrieving stats (inclusive)")],
        to: Annotated[date, Field(description="The end date for retrieving stats (inclusive). The difference between `from` and `to` should not exceed 31 days.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_all_account_stats_without_preload_content(
        self,
        var_from: Annotated[date, Field(description="The start date for retrieving stats (inclusive)")],
        to: Annotated[date, Field(description="The end date for retrieving stats (inclusive). The difference between `from` and `to` should not exceed 31 days.")],
        _request_timeout: Union[
    ...
    def _get_all_account_stats_serialize(
        self,
        var_from,
        to,
        _request_auth,
