...
class EmailApi:
    ...
    def send_email(
        self,
        email_message_object: Annotated[EmailMessageObject, Field(description="Email message details")],
        ...
        :param email_message_object: Email message details (required)
        :type email_message_object: EmailMessageObject
        ...
        _param = self._send_email_serialize(
            email_message_object=email_message_object,
    ...
    def _send_email_serialize(
        ...
        if email_message_object is not None:
            _body_params = email_message_object
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subaccount/email/',
    ...
    def send_email_with_template(
        self,
        email_message_with_template: Annotated[EmailMessageWithTemplate, Field(description="Email message details with template information")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param email_message_with_template: Email message details with template information (required)
        :type email_message_with_template: EmailMessageWithTemplate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._send_email_with_template_serialize(
            email_message_with_template=email_message_with_template,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def send_email_with_template_with_http_info(
        self,
        email_message_with_template: Annotated[EmailMessageWithTemplate, Field(description="Email message details with template information")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_email_with_template_without_preload_content(
        self,
        email_message_with_template: Annotated[EmailMessageWithTemplate, Field(description="Email message details with template information")],
        _request_timeout: Union[
            None,
    ...
    def _send_email_with_template_serialize(
        self,
        email_message_with_template,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if email_message_with_template is not None:
            _body_params = email_message_with_template
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subaccount/email/template',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
