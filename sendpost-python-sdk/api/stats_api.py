...
class StatsApi:
    ...
    @validate_call
    def account_subaccount_stat_subaccount_id_aggregate_get(
        self,
        var_from: Annotated[date, Field(description="Start date for stats retrieval.")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn't ne more than 60 days ) ")],
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the subaccount to retrieve")],
        ...
        :param var_from: Start date for stats retrieval. (required)
        :type var_from: date
        ...
        :type to: date
        :param subaccount_id: The ID of the subaccount to retrieve (required)
        :type subaccount_id: int
        ...
        _param = self._account_subaccount_stat_subaccount_id_aggregate_get_serialize(
            var_from=var_from,
            to=to,
    ...
    @validate_call
    def account_subaccount_stat_subaccount_id_aggregate_get_with_http_info(
        self,
        var_from: Annotated[date, Field(description="Start date for stats retrieval.")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn't ne more than 60 days ) ")],
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the subaccount to retrieve")],
    ...
    @validate_call
    def account_subaccount_stat_subaccount_id_aggregate_get_without_preload_content(
        self,
        var_from: Annotated[date, Field(description="Start date for stats retrieval.")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn't ne more than 60 days ) ")],
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the subaccount to retrieve")],
    ...
    def _account_subaccount_stat_subaccount_id_aggregate_get_serialize(
        self,
        var_from,
        to,
        subaccount_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/subaccount/stat/{subaccount_id}/aggregate',
    ...
    @validate_call
    def account_subaccount_stat_subaccount_id_get(
        self,
        var_from: Annotated[date, Field(description="Start date for stats retrieval.")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn't ne more than 60 days ) ")],
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the subaccount to retrieve")],
        ...
        _param = self._account_subaccount_stat_subaccount_id_get_serialize(
            var_from=var_from,
            to=to,
            subaccount_id=subaccount_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def account_subaccount_stat_subaccount_id_get_with_http_info(
        self,
        var_from: Annotated[date, Field(description="Start date for stats retrieval.")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn't ne more than 60 days ) ")],
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the subaccount to retrieve")],
    ...
    @validate_call
    def account_subaccount_stat_subaccount_id_get_without_preload_content(
        self,
        var_from: Annotated[date, Field(description="Start date for stats retrieval.")],
        to: Annotated[date, Field(description="Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn't ne more than 60 days ) ")],
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the subaccount to retrieve")],
    ...
    def _account_subaccount_stat_subaccount_id_get_serialize(
        self,
        var_from,
        to,
        subaccount_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/subaccount/stat/{subaccount_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_aggregate_stats_by_group(
        self,
        group: Annotated[StrictStr, Field(description="Group whose aggregated stats need to be retrieved")],
        var_from: Annotated[date, Field(description="The starting date for the aggregated stats")],
        to: Annotated[date, Field(description="The ending date for the aggregated stats (Note: `from` should be earlier than `to` and the date range should not exceed 366 days) ")],
        subaccount_id: Annotated[StrictInt, Field(description="The ID of the subaccount to retrieve")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type group: str
        :param var_from: The starting date for the aggregated stats (required)
        :type var_from: date
        :param to: The ending date for the aggregated stats (Note: `from` should be earlier than `to` and the date range should not exceed 366 days)  (required)
        :type to: date
        :param subaccount_id: The ID of the subaccount to retrieve (required)
        :type subaccount_id: int
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._get_aggregate_stats_by_group_serialize(
            group=group,
            var_from=var_from,
            to=to,
            subaccount_id=subaccount_id,
    ...
    @validate_call
    def get_aggregate_stats_by_group_with_http_info(
        self,
        group: Annotated[StrictStr, Field(description="Group whose aggregated stats need to be retrieved")],
        var_from: Annotated[date, Field(description="The starting date for the aggregated stats")],
        to: Annotated[date, Field(description="The ending date for the aggregated stats (Note: `from` should be earlier than `to` and the date range should not exceed 366 days) ")],
    ...
    @validate_call
    def get_aggregate_stats_by_group_without_preload_content(
        self,
        group: Annotated[StrictStr, Field(description="Group whose aggregated stats need to be retrieved")],
        var_from: Annotated[date, Field(description="The starting date for the aggregated stats")],
        to: Annotated[date, Field(description="The ending date for the aggregated stats (Note: `from` should be earlier than `to` and the date range should not exceed 366 days) ")],
    ...
    def _get_aggregate_stats_by_group_serialize(
        self,
        group,
        var_from,
        to,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/subaccount/stat/{subaccount_id}/group',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
