...
class IPPoolsApi:
    ...
    def create_ip_pool(
        self,
        ip_pool_create_request: IPPoolCreateRequest,
        ...
        :param ip_pool_create_request: (required)
        :type ip_pool_create_request: IPPoolCreateRequest
        ...
        _param = self._create_ip_pool_serialize(
            ip_pool_create_request=ip_pool_create_request,
    ...
    def _create_ip_pool_serialize(
        ...
        if ip_pool_create_request is not None:
            _body_params = ip_pool_create_request
    ...
    def delete_ip_pool(
        self,
        ippool_id: Annotated[StrictInt, Field(description="The ID of the IPPool to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ippool_id: The ID of the IPPool to delete (required)
        :type ippool_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def delete_ip_pool_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IPPoolDeleteResponse]:
        """Delete IPPool
    ...
    def _delete_ip_pool_serialize(
        ...
        if ippool_id is not None:
            _path_params['ippool_id'] = ippool_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/account/ippool/{ippool_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_ip_pools(
        ...
        search: Annotated[Optional[StrictStr], Field(description="Case insensitive search against IPPool name")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type offset: int
        :param search: Case insensitive search against IPPool name
        :type search: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_all_ip_pools_serialize(
            limit=limit,
            offset=offset,
            search=search,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_all_ip_pools_with_http_info(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Number of records to return per request")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Number of initial records to skip")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Case insensitive search against IPPool name")] = None,
    ...
    @validate_call
    def get_all_ip_pools_without_preload_content(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Number of records to return per request")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Number of initial records to skip")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Case insensitive search against IPPool name")] = None,
    ...
    def _get_all_ip_pools_serialize(
        self,
        limit,
        offset,
        search,
    ...
    @validate_call
    def get_ip_pool_by_id(
        self,
        ippool_id: Annotated[StrictInt, Field(description="The ID of the IPPool whose information you want to retrieve")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ippool_id: The ID of the IPPool whose information you want to retrieve (required)
        :type ippool_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_ip_pool_by_id_serialize(
            ippool_id=ippool_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_ip_pool_by_id_with_http_info(
        self,
        ippool_id: Annotated[StrictInt, Field(description="The ID of the IPPool whose information you want to retrieve")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_ip_pool_by_id_without_preload_content(
        self,
        ippool_id: Annotated[StrictInt, Field(description="The ID of the IPPool whose information you want to retrieve")],
        _request_timeout: Union[
            None,
    ...
    def _get_ip_pool_by_id_serialize(
        self,
        ippool_id,
        _request_auth,
        _content_type,
    ...
    def update_ip_pool(
        self,
        ippool_id: Annotated[StrictInt, Field(description="The ID of the IPPool to update")],
        ip_pool_update_request: IPPoolUpdateRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ippool_id: The ID of the IPPool to update (required)
        :type ippool_id: int
        :param ip_pool_update_request: (required)
        :type ip_pool_update_request: IPPoolUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_ip_pool_serialize(
            ippool_id=ippool_id,
            ip_pool_update_request=ip_pool_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_ip_pool_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if ip_pool_update_request is not None:
            _body_params = ip_pool_update_request
