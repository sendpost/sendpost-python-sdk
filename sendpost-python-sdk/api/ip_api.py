...
class IPApi:
    ...
    def allocate_new_ip(
        self,
        ip_allocation_request: IPAllocationRequest,
        ...
        :param ip_allocation_request: (required)
        :type ip_allocation_request: IPAllocationRequest
        ...
        _param = self._allocate_new_ip_serialize(
            ip_allocation_request=ip_allocation_request,
    ...
    @validate_call
    def allocate_new_ip_with_http_info(
        self,
        ip_allocation_request: IPAllocationRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def allocate_new_ip_without_preload_content(
        self,
        ip_allocation_request: IPAllocationRequest,
        _request_timeout: Union[
            None,
    ...
    def _allocate_new_ip_serialize(
        self,
        ip_allocation_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if ip_allocation_request is not None:
            _body_params = ip_allocation_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/account/ip/allocate',
    ...
    def delete_ip(
        self,
        ip_id: Annotated[StrictInt, Field(description="The ID of the IP resource to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ip_id: The ID of the IP resource to delete (required)
        :type ip_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_ip_serialize(
            ip_id=ip_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def delete_ip_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IPDeletionResponse]:
        """Delete IP
    ...
    @validate_call
    def delete_ip_without_preload_content(
        self,
        ip_id: Annotated[StrictInt, Field(description="The ID of the IP resource to delete")],
        _request_timeout: Union[
            None,
    ...
    def _delete_ip_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/account/ip/{ip_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_ips(
        ...
        search: Annotated[Optional[StrictStr], Field(description="Case insensitive search against IP's public IP address")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type offset: int
        :param search: Case insensitive search against IP's public IP address
        :type search: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_specific_ip(
        self,
        ip_id: Annotated[StrictInt, Field(description="The ID of the IP resource to retrieve")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ip_id: The ID of the IP resource to retrieve (required)
        :type ip_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_specific_ip_serialize(
            ip_id=ip_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_specific_ip_with_http_info(
        self,
        ip_id: Annotated[StrictInt, Field(description="The ID of the IP resource to retrieve")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_specific_ip_without_preload_content(
        self,
        ip_id: Annotated[StrictInt, Field(description="The ID of the IP resource to retrieve")],
        _request_timeout: Union[
            None,
    ...
    def _get_specific_ip_serialize(
        self,
        ip_id,
        _request_auth,
        _content_type,
    ...
    def update_ip(
        self,
        ip_id: Annotated[StrictInt, Field(description="The ID of the IP resource to update")],
        ip_update_request: IPUpdateRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ip_id: The ID of the IP resource to update (required)
        :type ip_id: int
        :param ip_update_request: (required)
        :type ip_update_request: IPUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_ip_serialize(
            ip_id=ip_id,
            ip_update_request=ip_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_ip_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if ip_update_request is not None:
            _body_params = ip_update_request
