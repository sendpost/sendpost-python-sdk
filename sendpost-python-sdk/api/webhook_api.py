...
class WebhookApi:
    ...
    def delete_webhook(
        self,
        webhook_id: Annotated[StrictInt, Field(description="ID of the webhook to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param webhook_id: ID of the webhook to delete. (required)
        :type webhook_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/account/webhook/{webhook_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_webhooks(
        ...
        search: Annotated[Optional[StrictStr], Field(description="Case insensitive search against webhook URL.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type offset: int
        :param search: Case insensitive search against webhook URL.
        :type search: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_webhook(
        self,
        webhook_id: Annotated[StrictInt, Field(description="The ID of the webhook to retrieve.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param webhook_id: The ID of the webhook to retrieve. (required)
        :type webhook_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def update_webhook(
        self,
        webhook_id: Annotated[StrictInt, Field(description="ID of the webhook to update.")],
        ...
        :param webhook_id: ID of the webhook to update. (required)
        :type webhook_id: int
        :param update_webhook: (required)
