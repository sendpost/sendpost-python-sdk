...
class DomainApi:
    ...
    def get_all_domains(
        self,
        limit: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Number of records to return per request")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of initial records to skip")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Case insensitive search against domain names")] = None,
        ...
        :type offset: int
        :param search: Case insensitive search against domain names
        :type search: str
    ...
    def _get_all_domains_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subaccount/domain',
    ...
    @validate_call
    def subaccount_domain_domain_id_delete(
        self,
        domain_id: Annotated[StrictStr, Field(description="The unique ID of the domain to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param domain_id: The unique ID of the domain to delete. (required)
        :type domain_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._subaccount_domain_domain_id_delete_serialize(
            domain_id=domain_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def subaccount_domain_domain_id_delete_with_http_info(
        self,
        domain_id: Annotated[StrictStr, Field(description="The unique ID of the domain to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def subaccount_domain_domain_id_delete_without_preload_content(
        self,
        domain_id: Annotated[StrictStr, Field(description="The unique ID of the domain to delete.")],
        _request_timeout: Union[
            None,
    ...
    def _subaccount_domain_domain_id_delete_serialize(
        self,
        domain_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/subaccount/domain/{domain_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def subaccount_domain_domain_id_get(
        self,
        domain_id: Annotated[StrictStr, Field(description="The unique ID of the domain to retrieve.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param domain_id: The unique ID of the domain to retrieve. (required)
        :type domain_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._subaccount_domain_domain_id_get_serialize(
            domain_id=domain_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def subaccount_domain_domain_id_get_with_http_info(
        self,
        domain_id: Annotated[StrictStr, Field(description="The unique ID of the domain to retrieve.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def subaccount_domain_domain_id_get_without_preload_content(
        self,
        domain_id: Annotated[StrictStr, Field(description="The unique ID of the domain to retrieve.")],
        _request_timeout: Union[
            None,
    ...
    def _subaccount_domain_domain_id_get_serialize(
        self,
        domain_id,
        _request_auth,
        _content_type,
    ...
    def subaccount_domain_post(
        ...
        _param = self._subaccount_domain_post_serialize(
    ...
    @validate_call
    def subaccount_domain_post_with_http_info(
        self,
        create_domain_request: CreateDomainRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def subaccount_domain_post_without_preload_content(
        self,
        create_domain_request: CreateDomainRequest,
        _request_timeout: Union[
            None,
    ...
    def _subaccount_domain_post_serialize(
        self,
