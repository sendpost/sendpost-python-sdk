    ...
    def make_instance(self, include_optional) -> WebhookObject:
        ...
        if include_optional:
            return WebhookObject(
                event = sendpost_python_sdk.models.event.Event(
                ...
                email_message = sendpost_python_sdk.models.email_message.EmailMessage(
                    message_id = 'mjhl-1401-sasdf-129324', 
                    account_id = 117, 
                    sub_account_id = 117, 
                    ip_id = 123, 
                    ...
                    email_type = 'default', 
                    submitted_at = 1567512491587205024, 
                    from = sendpost_python_sdk.models.email_message_from.EmailMessage_from(
                        name = 'Richard', 
